...
@interface iCarousel_TimeMachine ()
...
NSComparisonResult compareViewDepth_T(UIView *view1, UIView *view2, iCarousel_TimeMachine *self);
...
@implementation iCarousel_TimeMachine
...
- (void)depthSortViews
{
    for (UIView *view in [[itemViews allValues] sortedArrayUsingFunction:(NSInteger (*)(id, id, void *))compareViewDepth_T context:(__bridge void *)self])
    {
