...
@interface iCarousel_TimeMachine : UIView
...
@property (nonatomic, copy) NSString *strId;//my Cui
...
- (UIView *)carousel:(iCarousel_TimeMachine *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(UIView *)view;

@optional

- (NSUInteger)numberOfPlaceholdersInCarousel:(iCarousel_TimeMachine *)carousel;
- (UIView *)carousel:(iCarousel_TimeMachine *)carousel placeholderViewAtIndex:(NSUInteger)index reusingView:(UIView *)view;
...
- (UIView *)carousel:(iCarousel_TimeMachine *)carousel viewForItemAtIndex:(NSUInteger)index __deprecated;
- (UIView *)carousel:(iCarousel_TimeMachine *)carousel placeholderViewAtIndex:(NSUInteger)index __deprecated;
...
- (void)carouselWillBeginScrollingAnimation:(iCarousel_TimeMachine *)carousel;
- (void)carouselDidEndScrollingAnimation:(iCarousel_TimeMachine *)carousel;
- (void)carouselDidScroll:(iCarousel_TimeMachine *)carousel;
- (void)carouselCurrentItemIndexUpdated:(iCarousel_TimeMachine *)carousel;
...
- (CGFloat)carouselOffsetMultiplier:(iCarousel_TimeMachine *)carousel;
...
- (CATransform3D)carousel:(iCarousel_TimeMachine *)carousel itemTransformForOffset:(CGFloat)offset baseTransform:(CATransform3D)transform;
- (CGFloat)carousel:(iCarousel_TimeMachine *)carousel valueForTransformOption:(iCarouselTranformOption)option withDefault:(CGFloat)value;

//deprecated, use transformForItemAtIndex:withOffset:baseTransform: instead
- (CATransform3D)carousel:(iCarousel_TimeMachine *)carousel transformForItemView:(UIView *)view withOffset:(CGFloat)offset __deprecated;

#ifdef ICAROUSEL_IOS

- (BOOL)carousel:(iCarousel_TimeMachine *)carousel shouldSelectItemAtIndex:(NSInteger)index;
